      ...
      <div className="bg-[#003A5D]">
        ...
        >
          <div className="max-w-4xl mx-auto text-center text-white">
            <h3 className="text-2xl md:text-[2.25rem] leading-tight font-bold">
            ...
            <div className="mt-8">
              <Button
                size="lg"
                className="bg-[#4BAEA0] hover:bg-[#3E8E82] text-white text-base md:text-lg px-8 py-6 rounded-2xl shadow-lg"
                onClick={() => {
