  ...
  return (
    ...
    >
      <div className="bg-gradient-to-br from-white via-brand-mint-200/10 to-white rounded-xl shadow-soft p-6 sm:p-8 border border-brand-mint-200/30">
        ...
        {/* Recursos específicos basados en el plan */}
        {specificResources.length > 0 && (
          <div className="mb-8">
            <h3 className="font-heading text-lg font-semibold text-brand-ink-900 mb-4">
              ...
              {specificResources.map((resource, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <p className="font-body text-xs text-brand-olive-500 mb-3 leading-relaxed">
                ...
                >
                  <div className="flex items-start gap-3 mb-3">
                    <div className="p-2 bg-brand-mint-200/60 rounded-full">
                      <IconComponent className="h-4 w-4 text-brand-ink-800" />
                    </div>
                    <div className="flex-1">
                      <h4 className="font-heading text-sm font-semibold text-brand-ink-900">
                        {resource.title}
